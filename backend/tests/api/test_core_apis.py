...
class TestClinicsAPI:
    ...
    async def test_create_clinic_with_slug(
        self,
        client: AsyncClient,
        auth_headers: dict,
    ):
    ...
    async def test_create_clinic_with_gst(
        self,
        client: AsyncClient,
        auth_headers: dict,
    ):
    ...
    async def test_list_clinics_with_pagination(
        self,
        client: AsyncClient,
        auth_headers: dict,
    ):
    ...
    async def test_get_clinic_by_slug(
        ...
        response = await client.get(f"/api/v1/clinics/slug/{test_clinic.slug}")
        assert response.status_code == 200
        data = response.json()
        assert data["id"] == str(test_clinic.id)
        assert data["slug"] == test_clinic.slug
    ...
    async def test_get_clinic_by_invalid_slug(
        self,
        client: AsyncClient,
    ):
        """Test getting clinic with invalid slug."""
        response = await client.get("/api/v1/clinics/slug/nonexistent-clinic")
        assert response.status_code == 404
    ...
    async def test_get_clinic_stats(
        self,
        client: AsyncClient,
        auth_headers: dict,
        test_clinic: Clinic,
...
class TestDoctorsAPI:
    ...
    async def test_create_doctor_minimal(
        self,
        client: AsyncClient,
        auth_headers: dict,
        test_clinic: Clinic,
    ...
    async def test_list_doctors_by_clinic(
        self,
        client: AsyncClient,
        auth_headers: dict,
        test_clinic: Clinic,
        ...
        response = await client.get(
            f"/api/v1/doctors/?clinic_id={str(test_clinic.id)}",
            headers=auth_headers,
        )
        assert response.status_code == 200
        data = response.json()
    ...
    async def test_list_doctors_by_specialization(
        self,
        client: AsyncClient,
        auth_headers: dict,
        test_doctor: Doctor,
    ...
    async def test_update_doctor_specialization(
        self,
        client: AsyncClient,
        auth_headers: dict,
        test_doctor: Doctor,
    ...
    async def test_update_doctor_consultation_fee(
        self,
        client: AsyncClient,
        auth_headers: dict,
        test_doctor: Doctor,
    ...
    async def test_list_doctors_public(
        ...
        response = await client.get(f"/api/v1/doctors/clinic/{test_clinic.id}/public")
        assert response.status_code == 200
        data = response.json()
        assert isinstance(data, list)
...
class TestServicesAPI:
    ...
    async def test_create_service_minimal(
        self,
        client: AsyncClient,
        auth_headers: dict,
        test_clinic: Clinic,
    ...
    async def test_list_services_by_clinic(
        self,
        client: AsyncClient,
        auth_headers: dict,
        test_clinic: Clinic,
        ...
        response = await client.get(
            f"/api/v1/services/?clinic_id={str(test_clinic.id)}",
            headers=auth_headers,
        )
        assert response.status_code == 200
        data = response.json()
...
class TestSearchAPI:
    ...
    async def test_search_patients_by_name(
        ...
        response = await client.get(
            f"/api/v1/search/?q={test_patient.first_name[:5]}",
            headers=auth_headers,
        )
        assert response.status_code == 200
        data = response.json()
    ...
    async def test_search_with_collections_filter(
        self,
        client: AsyncClient,
        auth_headers: dict,
        test_patient: Patient,
        ...
        response = await client.get(
            f"/api/v1/search/?q={test_patient.first_name}&collections=patients",
            headers=auth_headers,
        )
        assert response.status_code == 200
        data = response.json()
    ...
    async def test_search_index_status(
        self,
        client: AsyncClient,
        auth_headers: dict,
    ):
    ...
    async def test_search_initialize_index(
        self,
        client: AsyncClient,
        auth_headers: dict,
    ):
    ...
    async def test_index_appointment(
        self,
        client: AsyncClient,
        auth_headers: dict,
        test_appointment,
...
class TestClinicsValidation:
    ...
    async def test_create_clinic_invalid_phone(
        self,
        client: AsyncClient,
        auth_headers: dict,
    ):
    ...
    async def test_create_clinic_invalid_slug(
        self,
        client: AsyncClient,
        auth_headers: dict,
    ):
    ...
    async def test_create_clinic_missing_name(
        self,
        client: AsyncClient,
        auth_headers: dict,
    ):
...
class TestDoctorsValidation:
    ...
    async def test_create_doctor_missing_name(
        self,
        client: AsyncClient,
        auth_headers: dict,
        test_clinic: Clinic,
    ...
    async def test_create_doctor_negative_fee(
        self,
        client: AsyncClient,
        auth_headers: dict,
        test_clinic: Clinic,
    ...
    async def test_create_doctor_invalid_slot_duration(
        self,
        client: AsyncClient,
        auth_headers: dict,
        test_clinic: Clinic,
...
class TestServicesValidation:
    ...
    async def test_create_service_missing_name(
        self,
        client: AsyncClient,
        auth_headers: dict,
        test_clinic: Clinic,
    ...
    async def test_create_service_missing_price(
        self,
        client: AsyncClient,
        auth_headers: dict,
        test_clinic: Clinic,
    ...
    async def test_create_service_negative_price(
        self,
        client: AsyncClient,
        auth_headers: dict,
        test_clinic: Clinic,
    ...
    async def test_create_service_invalid_tax_rate(
        self,
        client: AsyncClient,
        auth_headers: dict,
        test_clinic: Clinic,
    ...
    async def test_create_service_invalid_duration(
        self,
        client: AsyncClient,
        auth_headers: dict,
        test_clinic: Clinic,
